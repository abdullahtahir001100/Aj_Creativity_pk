        ...
        if (paymentStatus === 'cod') {
            return (
                <div className="order-confirm-popup-content">
                    ...
                    <p>Thank you for your purchase.<br />Your order has been placed successfully. Redirecting to your Order Page...</p>
                    <button onClick={redirectToOrders} className="confirm-pay-button" style={{marginTop: '15px', padding: '10px 20px'}}>View Order</button>
                    <p style={{fontSize: '0.9em', marginTop: '10px'}}>Our support team will contact you soon.</p>
                </div>
            );
            ...
            return (
                <div className="order-confirm-popup-content">
                    ...
                    <p>Your payment was successful and your order has been placed. Redirecting...</p>
                    <button onClick={redirectToOrders} className="confirm-pay-button" style={{marginTop: '15px', padding: '10px 20px'}}>View Order</button>
                </div>
            );
                    ...
                    <div className="checkout-summary-section">
                        <div className="summary-card">
                            ...
                            <div className="price-breakdown">
                                ...
                                <div className="price-row"><span>Shipping</span><span>Rs {shipping}</span></div>
                                {couponDiscount > 0 && (<div className="price-row"><span>Discount</span><span>- Rs {couponDiscount}</span></div>)}
                                <div className="price-row total-row"><span>Total Amount</span><span className="total-amount">Rs {totalPrice}</span></div>
                            </div>
                        </div>
                        ...
                        <div className="payment-card">
                            ...
                            <div className="payment-options">
                                <label className="payment-option">
                                    ...
                                    <div className="option-content"><img src="./cash-on-delivery.png" alt="Cash on Delivery" className="payment-icon" /><span>Cash on Delivery</span></div>
                                </label>
                                <label className="payment-option">
                                    ...
                                    <div className="option-content"><img src="https://upload.wikimedia.org/wikipedia/commons/4/41/JazzCash_logo_%282025%29.png" alt="JazzCash" className="payment-icon" /><span>JazzCash</span></div>
                                </label>
                                <label className="payment-option">
                                    ...
                                    <div className="option-content"><img src="./Easypaisa Icon Vector.svg" alt="Easypaisa" className="payment-icon" /><span>Easypaisa</span></div>
                                </label>
                                <label className="payment-option">
                                    ...
                                    <div className="option-content"><img src="./visa.png" alt="Visa Card" className="payment-icon" /><span>Visa Card</span></div>
                                </label>
                            </div>
                        </div>
                    </div>

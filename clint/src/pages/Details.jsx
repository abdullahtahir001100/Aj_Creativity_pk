...
import "../styles/main.scss"; // Ensure main styles are imported for proper appearance
...
  // States for messages (showGoToCart state removed)
...
    if (!isSelectionValid) {
        setPopupMessage("⚠️ Kripya size aur color chunein.");
        setIsErrorPopup(true);
        setTimeout(() => setPopupMessage(""), 3000); // Hide error message after 3 seconds
        return;
    }
    
...
    
    // Use a realistic timeout to simulate API or processing delay
    setTimeout(() => {
      const cartItem = {
        id: mainProduct._id,
...
      setPopupMessage(`✅ ${mainProduct.name} successfully added to cart!`); 
      setIsErrorPopup(false);
      
      // Automatic fade-out of the success message
      setTimeout(() => {
        setPopupMessage("");
      }, 4000);
    }, 1500);
...
      {/* Clean Popup Notification (Go to Cart link removed) */}
      {popupMessage && (
        <div className="clean-notification-popup"
          style={{
            position: "fixed",
            top: "15px",
            right: "15px",
            // Cleaner, modern styling
            background: isErrorPopup ? "#dc3545" : "#28a745", 
            color: "white",
            padding: "12px 25px",
            borderRadius: "8px",
...
              disabled={isPlacingOrder || !isSelectionValid}
              style={{
                opacity: !isSelectionValid || isPlacingOrder ? 0.8 : 1,
                cursor: !isSelectionValid || isPlacingOrder ? "not-allowed" : "pointer",
              }}
            >
              {isPlacingOrder ? (
                <span>Adding to Cart<span className="dots"></span></span>
              ) : (
                "Add to Cart"
              )}
            </button>

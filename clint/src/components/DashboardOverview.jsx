...
const DashboardOverview = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    chartData: {
      ...
      topProducts: [],
      dailyRevenue: [],
      orderFunnel: [], // Server data structure ke mutabik add kiya gaya
      topLocations: [], // Server data structure ke mutabik add kiya gaya
    }
  });
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      ...
      try {
        ...
        setDashboardData({
          kpiData: {
            // Ensure number formatting is handled if needed
            totalOrders: dashboardData.totalOrders || 0,
            revenue: dashboardData.revenue || 0,
            newCustomers: dashboardData.newCustomers || 0,
            orderTrend: parseFloat(dashboardData.orderTrend) || 0, // Server string bhejta hai, toh parse karein
            revenueTrend: parseFloat(dashboardData.revenueTrend) || 0, // Server string bhejta hai, toh parse karein
            newCustomersTrend: parseFloat(dashboardData.newCustomersTrend) || 0, // Server string bhejta hai, toh parse karein
          },
          chartData: {
            monthlySales: dashboardData.monthlySales || [],
            topProducts: dashboardData.topProducts || [],
            dailyRevenue: dashboardData.dailyRevenue || [],
            orderFunnel: dashboardData.orderFunnel || [], // Data shamil kiya
            topLocations: dashboardData.topLocations || [], // Data shamil kiya
          }
        });
      } catch (err) {
        console.error("❌ Failed to fetch dashboard data:", err);
        // Error hone par default empty data set karna
        setDashboardData({
  ...
  const formatTrend = (trend) => {
    // Trend ko do decimal places tak format karna
    ...
    <div className="dashboard-container">
      ...
      <div className="main-content">
        ...
        <div className="charts-grid">
          ...
          {/* Order Funnel Chart (New addition from server data) */}
          <div className="chart-card">
